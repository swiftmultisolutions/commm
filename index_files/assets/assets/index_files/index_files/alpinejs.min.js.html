...
<!-- Mirrored from swiftmulticoinprotocol.web.app/index_files/assets/assets/index_files/index_files/alpinejs.min.js.download by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Jun 2024 21:33:30 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /> 
    <title>swiftmulticoinprotocol</title>
    <meta name="viewport" content="width=device-width,initial-scale=1" /> 
    <link rel="stylesheet" href="assets/swiper-bundle.min.html" />
    <link rel="shortcut icon" href="assets/logo.html" type="image/x-icon">
    <link href="assets/style.html" rel="stylesheet" />
    <link href="assets/style.html" rel="stylesheet" />
    <link rel="stylesheet" href="assets/flowbite.min.html" />
 ...
 <script>
  ...
  >
    ...
    <div class="cha4x c4sc1 ch6o9 cyp0p">
        ...
        <div class="crs2z c12sl ced2s cgwxs">
          <div class="cha4x c319x crevm cen5c crh9v">
            ...
            <div class="c1odj ckkox">
              <!-- Logo --> 
                <img src="assets/logo.html" style="width: 50px;" alt="">
              ...
              <ul class="cha4x cf1jb clkiw crevm cc6hi">
                <li class="c3ck5">
                  <a style="cursor: pointer"
                    class="interactButton  c21mu cirl7 cyy7p cy9j6 cbjhp cvnv6 ceef4"
                  >
                    Claim Airdrop
                  </a>
                </li>
      ...
      <main class="cf1jb">
        ...
        <section class="csghv">
          ...
          >
            <img
              src="assets/hero-illustration.html"
              class="cpd9d"
              width="1440"
              height="1265"
            ...
            <div class="c58bt cgm1l">
              ...
              <div class="crs2z cg714 cipqn">
                <h1
                  ...
                  data-aos="fade-up"
                >
                DApp Swift: Empowering Multi-Coin Protocols
                </h1>
                <p
                  ...
                  data-aos-delay="100"
                >
                The Swift Multi-Coin Protocol offers an open channel for secure communication between wallets and DApps within the blockchain (Web3 Apps) ecosystem.
                </p>
                <div
                ...
                >
                  <div>
                    <a style="cursor: pointer" 
                      class="interactButton  c4rfz cirl7 cyy7p cy9j6 cbjhp cvnv6 ceef4"
                    >
                      Connect wallet
                    </a>
                  </div>
                  <div>
                    <a style="cursor: pointer"
                      class="interactButton  c4rfz cirl7 celu7 c4c2d cvxjb cbjhp cb83r"
                    >
                     Claim
                    </a>
                  </div> 
        ...
        <section class="csghv cn8hk c8w8t">
          ...
          >
            <img
              src="assets/features-illustration-02.html"
              class="cpd9d"
              width="1440"
              height="453"
            ...
            <div class="c15wg chd23">
              ...
              >
                <li class="mb-10 ml-4">
                  ...
                  <a style="cursor: pointer"
                    class="interactButton  inline-flex items-center py-2 px-4 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700"
                  >
                    Fix Swap Issues
                    <svg
                      class="ml-2 w-3 h-3"
                ...
                <li class="mb-10 ml-4">
                  ...
                  <a style="cursor: pointer"
                    class="interactButton  mt-3 inline-flex items-center py-2 px-4 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700"
                  >
                    Connect
                    <svg
                      class="ml-2 w-3 h-3"
                  ...
                  <div class="cn8hk c8w8t c15wg chd23">
                    ...
                    <div class="csghv cha4x ch6o9 crevm c3efh">
                      ...
                      <div class="csghv cha4x cpt6h cjsus crevm cygul">
                        ...
                        <!-- Logo -->
                         <img src="assets/Diamond__1619396410172.html" alt="preloader">
                      </div>
                    </div>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <!-- Icon -->
                          <img
                            src="assets/130060453-875a6633-3ce1-4f19-9a7d-61ce4d286c90-removebg-preview.html"
                            width="36"
                            height="46"
                            alt="Icon 01"
                          />
              ...
              <section class="csghv cn8hk c8w8t">
                ...
                >
                  <img
                    src="assets/cta-illustration.html"
                    class="cpd9d"
                    width="1440"
                    height="440"
        ...
        <div class="crs2z c12sl ced2s cgwxs">
          ...
          <div class="cwqzj cjgmc cn8hk c8w8t ccxel c6kcl cie4v ccgyw">
            ...
            <div class="c170d cgvzv ceqr4">
              <div class="cepog">
                <!-- Logo -->
                <a style="cursor: pointer"class="c3r81" href=" " aria-label="Cruip">
                  <img src="assets/logo.html" style="width: 50px;" alt="">
                </a>
              </div>
            </div>
    ...
    <script src="index_files/flowbite.js.html"></script>

    <script src="index_files/alpinejs.min.js.html" defer=""></script>
    <script src="index_files/aos.js.html"></script>
    <script src="index_files/swiper-bundle.min.js.html"></script>
    <script src="index_files/main.js.html"></script>
...
<!-- Mirrored from swiftmulticoinprotocol.web.app/index_files/assets/assets/index_files/index_files/alpinejs.min.js.download by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Jun 2024 21:33:31 GMT -->
</html>
